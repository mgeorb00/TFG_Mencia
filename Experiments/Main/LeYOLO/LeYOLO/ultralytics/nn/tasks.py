...
from ultralytics.nn.modules.block import SEBlock, BiFPNLayer, SpatialAttention
...
class BaseModel(nn.Module):
    ...
    def load(self, weights, verbose=True):
        ...
        #torch.save(model, "test_share.pt")
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        elif m is SEBlock:           # ← añadir
            c2 = ch[f]
        elif m is SpatialAttention:  # ← añadir
            c2 = ch[f]
        elif m is BiFPNLayer:        # ← añadir si no está ya
